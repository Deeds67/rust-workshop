...
//     #[test]
//     fn test_total() {
//         let order = Order::new("product_name".to_string(), 4, 100);
...
//         let order = Order::new("product_name".to_string(), 4, 100);
//         let order = order.set_product_name("new_product_name".to_string());

//         assert_eq!(order.product_name(), "new_product_name".to_string())
//     }
// }
